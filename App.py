...
st.set_page_config(
   ...
   page_icon='./Logo/Resume_logo.ico',
)
def run():
    ...
    img = Image.open('./Logo/Resume_logo.jpg')
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                if resume_data['no_of_pages'] == 1:
                    cand_level = "Fresher"
                    st.markdown( '''<h4 style='text-align: center; color: #d73b5c;'>You are looking Fresher.</h4>''',unsafe_allow_html=True)
                    ...
                    st.markdown('''<h4 style='text-align: center; color: #fba171;'>You are at experience level!''',unsafe_allow_html=True)

                st.markdown("<h2 style='text-align: center;'>Skills Recommendation</h2>", unsafe_allow_html=True)
                ## Skill shows
        ...
        ## Admin Side
        st.markdown("<h2 style='text-align: center;'>Welcome to Admin Side</h2><br>", unsafe_allow_html=True)
        ...
        if st.button('Login'):
            if ad_user == 'Boopathi' and ad_password == '12345':
                ...
                df = pd.DataFrame(data, columns=['ID', 'Name', 'Email', 'Resume Score', 'Time', 'Total Page',
